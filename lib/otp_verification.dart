      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('OTP Verification',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),),
            Text('Enter your phone number to receive a one-time password(OTP).'),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Verification Code',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),),
